      ...
      <section className="mx-auto max-w-7xl px-4 pb-20 sm:px-6 lg:px-8">
        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          {helpCategories.map((item, index) => (
            <div
              key={index}
              className="group rounded-3xl border border-white/10 bg-[#111827] p-8 transition duration-300 hover:-translate-y-2 hover:border-[#22C55E]/40"
            >
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        ...
        <div className="relative mx-auto max-w-7xl overflow-hidden rounded-4xl border border-white/10 bg-[#111827]">
          ...
          <div className="relative z-10 px-8 py-20 text-center sm:px-16">
            ...
            <h2 className="mx-auto max-w-4xl text-4xl font-bold sm:text-5xl">
              Still Need Help?
            </h2>
