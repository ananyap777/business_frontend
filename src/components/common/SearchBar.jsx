...
const SearchBar = ({ searchTerm, setSearchTerm }) => {
  return (
    <div className="w-full rounded-2xl border border-[#E5E7EB] bg-white p-3 shadow-sm">
      <div className="flex w-full flex-col gap-3 sm:flex-row">
        ...
        <button className="flex h-12 w-full shrink-0 items-center justify-center gap-2 rounded-xl bg-[#22C55E] px-5 text-sm font-semibold text-white transition hover:bg-green-600 sm:w-auto">
